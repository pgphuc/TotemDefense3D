...
public class State_Reinforcing_Village : StateBase<VillageBase>
{
    public State_Reinforcing_Village(VillageBase unit, StateMachine<VillageBase> stateMachine) : base(unit, stateMachine)
    {
    ...
    {
        base.OnEnter();
        _unit._spawnerComponent.Reinforcement();//Tạo coroutine

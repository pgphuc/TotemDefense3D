...
public class State_RangedAttack_Enemy_Ranged : StateBase<EnemyRangedBase>
{
    public State_RangedAttack_Enemy_Ranged(EnemyRangedBase unit, StateMachine<EnemyRangedBase> stateMachine) : base(unit, stateMachine)
    {
